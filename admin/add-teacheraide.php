...
if (strlen($_SESSION['sturecmsaid']) == 0) {
    ...
    if (isset($_POST['submit'])) {
        ...
        $uid = createAccount($uname, $password, 'Teacher Aide');
        ...
        if (in_array($extension, $allowed_extensions)) {
           ...
           //$query->bindParam(':password', $password, PDO::PARAM_STR);
            ...
            if ($query->execute()) {
                echo '<script>alert("Teacher Aide has been added.")</script>';
                echo "<script>window.location.href ='add-teacheraide.php'</script>";
            } else {
                ...
                <div class="content-wrapper">
                    ...
                    <div class="row">
                        <div class="col-12 grid-margin stretch-card">
                            <div class="card">
                                <div class="card-body">
                                    <h4 class="card-title" style="text-align: center;">Teacher Aide</h4>
