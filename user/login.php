...
if(isset($_POST['login'])) {
    ...
    $sql ="SELECT StuID,ID FROM tblstudent WHERE (UserName=:stuid || StuID=:stuid) and Password=:password";
                    ...
                    <div class="auth-form-light text-left p-5">
                        ...
                        <form class="pt-3" id="login" method="post" name="login">
                            <div class="form-group">
                                <input type="text" class="form-control form-control-lg" placeholder="Username" required="true" name="stuid" value="<?php if(isset($_COOKIE["user_login"])) { echo $_COOKIE["user_login"]; } ?>" >
                            </div>
                            <div class="form-group">
