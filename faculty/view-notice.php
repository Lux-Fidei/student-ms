                        ...
                        <div class="card">
                            <div class="card-body">
                                <table border="1" class="table table-bordered mg-b-0">
                                    ...
                                    $sql = "SELECT tblfaculty.ID, tblfaculty.FirstName, tblnotice.NoticeTitle, tblnotice.CreationDate, tblnotice.NoticeMsg, tblnotice.ID as nid FROM tblnotice JOIN tblfaculty ON tblfaculty.ID = tblnotice.Id WHERE tblnotice.Id = :facultyID";
