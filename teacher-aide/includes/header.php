<nav class="navbar default-layout-navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
        ...
        $sql="SELECT CONCAT(f.FirstName, ' ', f.MiddleInitial, '.', ' ', f.LastName) AS FullName, f.FirstName, f.Email, f.Image, u.Type FROM tblfaculty f JOIN tbl_user_accounts u ON f.ID = u.ID WHERE u.ID = :uid";
