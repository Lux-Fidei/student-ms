                            ...
                            <div class="card">
                                ...
                                <div>
                                    <div style="display: flex; margin-bottom: 8px">
                                        <div style="margin: 0">Name of Students for Graduation </div>
                                        <?php
                                    ...
                                    <table id="studentTable">
                                        ...
                                        <tbody>
                                        <?php
                                        if(isset($_POST['submit']) !== "" && isset($_POST['strand']) && $_POST['strand'] !== "") {
                                            $gradelevel = 13;
                                            $query = "SELECT * FROM tblstudent WHERE GradeLevel = :gradelevel AND Strand = :strand";
                                            ...
                                            $gradelevel = 13;
                                            $query = "SELECT * FROM tblstudent WHERE GradeLevel = :gradelevel";
                                            $query = $dbh->prepare($query); // Use the grade_level value from the tblstudent table
                                            $query->bindParam(':gradelevel', $gradelevel,PDO::PARAM_STR);
                                            $query->execute();
                                            $results = $query->fetchAll(PDO::FETCH_OBJ);
